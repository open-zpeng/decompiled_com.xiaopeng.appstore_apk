    ...
    public static final <T> Object await(final Call<T> call, Continuation<? super T> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (body == null) {
                        ...
                        CancellableContinuation.this.resumeWith(Result.m32constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                        return;
                    }
                    Result.Companion companion2 = Result.Companion;
                    CancellableContinuation.this.resumeWith(Result.m32constructorimpl(body));
                    return;
                }
                Result.Companion companion3 = Result.Companion;
                CancellableContinuation.this.resumeWith(Result.m32constructorimpl(ResultKt.createFailure(new HttpException(response))));
            }
            ...
            public void onFailure(Call<T> call2, Throwable t) {
                ...
                Result.Companion companion = Result.Companion;
                CancellableContinuation.this.resumeWith(Result.m32constructorimpl(ResultKt.createFailure(t)));
            }
        });
    ...
    public static final <T> Object awaitResponse(final Call<T> call, Continuation<? super Response<T>> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                Intrinsics.checkParameterIsNotNull(response, "response");
                Result.Companion companion = Result.Companion;
                CancellableContinuation.this.resumeWith(Result.m32constructorimpl(response));
            }
