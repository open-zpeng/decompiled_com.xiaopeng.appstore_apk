...
public class BuildInfoUtils {
    ...
    public static String getVin() {
        return getString("persist.sys.xiaopeng.vin");
    }
    ...
    public static int getHardwareVersionCode() {
        ...
        try {
            return Integer.parseInt(hardwareVersion.substring(3));
    ...
    public static String getBid() {
        ...
        return (!TextUtils.isEmpty(fullSystemVersion) && (indexOf = fullSystemVersion.indexOf("_")) > 1) ? fullSystemVersion.substring(indexOf - 1, indexOf) : "4";
    }
    ...
    public static boolean isPTSpecialVersion() {
        return "5".equals(getBid()) || "6".equals(getBid());
    }
