...
public class ItemUpgradeLayoutBindingLandImpl extends ItemUpgradeLayoutBinding implements OnClickListener.Listener {
    ...
    public ItemUpgradeLayoutBindingLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private ItemUpgradeLayoutBindingLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((32 & j) != 0) {
            this.btnExecute.setOnClickListener(this.mCallback18);
