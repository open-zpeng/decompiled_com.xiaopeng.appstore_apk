...
public class ItemWideAppBindingLandImpl extends ItemWideAppBinding implements OnClickListener.Listener {
    ...
    public ItemWideAppBindingLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private ItemWideAppBindingLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (XButton) bindings[5], null, (ImageView) bindings[1], new ViewStubProxy((ViewStub) bindings[6]), (XTextView) bindings[3], (XTextView) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.xiaopeng.appstore.appstore_ui.databinding.ItemWideAppBinding
    ...
    */
    protected void executeBindings() {
        ...
        Lb8:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaopeng.appstore.appstore_ui.databinding.ItemWideAppBindingLandImpl.executeBindings():void");
    }
