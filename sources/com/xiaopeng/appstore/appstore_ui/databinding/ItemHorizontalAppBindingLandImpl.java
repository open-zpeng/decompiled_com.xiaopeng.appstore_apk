...
public class ItemHorizontalAppBindingLandImpl extends ItemHorizontalAppBinding implements OnClickListener.Listener {
    ...
    public ItemHorizontalAppBindingLandImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private ItemHorizontalAppBindingLandImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 32) != 0) {
            this.layoutBtn.setOnClickListener(this.mCallback6);
