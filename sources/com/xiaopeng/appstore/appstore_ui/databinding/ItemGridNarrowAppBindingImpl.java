...
public class ItemGridNarrowAppBindingImpl extends ItemGridNarrowAppBinding implements OnClickListener.Listener {
    ...
    public ItemGridNarrowAppBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private ItemGridNarrowAppBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (XButton) bindings[4], (FrameLayout) bindings[3], (ImageView) bindings[1], new ViewStubProxy((ViewStub) bindings[5]), (XTextView) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.xiaopeng.appstore.appstore_ui.databinding.ItemGridNarrowAppBinding
    ...
    */
    protected void executeBindings() {
        ...
        Lab:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaopeng.appstore.appstore_ui.databinding.ItemGridNarrowAppBindingImpl.executeBindings():void");
    }
