...
public class InternationalPendingUpgradeFragmentBindingImpl extends InternationalPendingUpgradeFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.fragment_pending_update_list_title, 5);
    }

    public InternationalPendingUpgradeFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private InternationalPendingUpgradeFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2, (XTextView) bindings[5], (LinearLayout) bindings[4], (RecyclerView) bindings[3]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.xiaopeng.appstore.international.databinding.InternationalPendingUpgradeFragmentBinding
