...
public class InternationalItemDetailViewModel extends ViewModel {
    ...
    private static final String INTRO_TITLE = ResUtils.getString(com.xiaopeng.appstore.appstore_ui.R.string.item_detail_desc_title);
    private static final String UPDATE_TITLE = ResUtils.getString(com.xiaopeng.appstore.appstore_ui.R.string.item_detail_update_title);
    ...
    private final View.OnClickListener mOnBackClick = new View.OnClickListener() { // from class: com.xiaopeng.appstore.international.InternationalItemDetailViewModel.1
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
            InternationalItemDetailViewModel.this.mOnBackEvent.call();
        }
    };
    private final SingleLiveEvent<AppDetailModel> mOnExecuteEvent = new SingleLiveEvent<>();
    private final View.OnClickListener mExecuteClick = new View.OnClickListener() { // from class: com.xiaopeng.appstore.international.InternationalItemDetailViewModel.2
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
            InternationalItemDetailViewModel.this.mOnExecuteEvent.setValue(InternationalItemDetailViewModel.this.mAppModel);
        }
    };
    private final SingleLiveEvent<AppDetailModel> mOnCancelEvent = new SingleLiveEvent<>();
    private final View.OnClickListener mCancelClick = new View.OnClickListener() { // from class: com.xiaopeng.appstore.international.InternationalItemDetailViewModel.3
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
            InternationalItemDetailViewModel.this.mOnCancelEvent.setValue(InternationalItemDetailViewModel.this.mAppModel);
        }
    };
    private final SingleLiveEvent<String> mOnRetryEvent = new SingleLiveEvent<>();
    private final View.OnClickListener mRetryClick = new View.OnClickListener() { // from class: com.xiaopeng.appstore.international.InternationalItemDetailViewModel.4
        @Override // android.view.View.OnClickListener
        public void onClick(View v) {
            InternationalItemDetailViewModel.this.mOnRetryEvent.call();
        }
    };
    ...
    private final ItemAssembleObserver mItemAssembleObserver = new SimpleItemAssembleObserver() { // from class: com.xiaopeng.appstore.international.InternationalItemDetailViewModel.5
        ...
        public void onStateChange(AssembleDataContainer data) {
            ...
            InternationalItemDetailViewModel.this.applyState(state);
            if (state == 7 || state == 0 || state == 6) {
                InternationalItemDetailViewModel.this.mOnDownloadFinish.postValue(null);
            }
        }
        ...
        public void onProgressChange(AssembleDataContainer data) {
            ...
            InternationalItemDetailViewModel.this.applyProgress(data.getProgress());
            InternationalItemDetailViewModel.this.mSpeed.postValue(Long.valueOf(data.getSpeedPerSecond()));
        }
    };
    private final AppComponentManager.OnAppsChangedCallback mOnAppsChangedCallback = new AppComponentManager.SimpleOnAppsChangedCallback() { // from class: com.xiaopeng.appstore.international.InternationalItemDetailViewModel.6
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            if (InternationalItemDetailViewModel.this.mAppModel.getPackageName().equals(packageName)) {
                InternationalItemDetailViewModel.this.applyStateChange();
            }
        }

        @Override // com.xiaopeng.appstore.bizcommon.logic.app.AppComponentManager.OnAppsChangedCallback
        public void onPackageAdded(List<AppInfo> appInfoList) {
            Logger.t(InternationalItemDetailViewModel.TAG).d("onPackageAdded");
            if (appInfoList == null || appInfoList.isEmpty()) {
                return;
            }
            for (AppInfo appInfo : appInfoList) {
                if (appInfo.componentName.getPackageName().equals(InternationalItemDetailViewModel.this.mAppModel.getPackageName())) {
                    InternationalItemDetailViewModel.this.applyStateChange();
                }
            }
        }
    };
    private final AppComponentManager.OnAppOpenCallback mOnAppOpenCallback = new AppComponentManager.OnAppOpenCallback() { // from class: com.xiaopeng.appstore.international.InternationalItemDetailViewModel.7
        ...
        public void onAppOpen(String packageName) {
            if (InternationalItemDetailViewModel.this.mAppModel.getPackageName().equals(packageName)) {
                InternationalItemDetailViewModel.this.startLoading();
            }
        }
    ...
    public void request(String id) {
        if (TextUtils.isEmpty(id)) {
            ...
            this.mResourceLiveData.postValue(Resource.empty(ResUtils.getString(com.xiaopeng.appstore.appstore_ui.R.string.detail_page_no_app), null));
            return;
        }
        ...
        if (SilentInstallHelper.USE_DETAILS_LIST_API) {
            ...
            this.mResourceLiveData.addSource(this.mXpAppService.getAppDetails(appDetailListRequest), new Observer() { // from class: com.xiaopeng.appstore.international.-$$Lambda$InternationalItemDetailViewModel$Vh2Crxsh1vT16S3hChHqF16R1IY
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    InternationalItemDetailViewModel.this.onListResponseChanged((ApiResponse) obj);
                }
            });
            return;
        }
        ...
        this.mResourceLiveData.addSource(this.mXpAppService.getAppDetail(appDetailRequest), new Observer() { // from class: com.xiaopeng.appstore.international.-$$Lambda$InternationalItemDetailViewModel$L-DUFYLd01PeP9ung76SfId__lk
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                InternationalItemDetailViewModel.this.onSingleResponseChanged((ApiResponse) obj);
            }
        });
    }
    ...
    private void handleResponseFailed(ApiResponse apiResponse) {
        if (apiResponse instanceof ApiEmptyResponse) {
            ...
            this.mResourceLiveData.postValue(Resource.error(ResUtils.getString(com.xiaopeng.appstore.appstore_ui.R.string.net_error_page), null));
        } else {
