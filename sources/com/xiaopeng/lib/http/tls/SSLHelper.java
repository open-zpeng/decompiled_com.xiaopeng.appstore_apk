...
public class SSLHelper {
    ...
    public static class TLS2SocketFactory extends SSLSocketFactory {
        ...
        public Socket createSocket(Socket socket, String str, int i, boolean z) throws IOException {
            return patch(this.delegate.createSocket(socket, str, i, z), str + ":" + i);
        }

        @Override // javax.net.SocketFactory
        public Socket createSocket(String str, int i) throws IOException {
            return patch(this.delegate.createSocket(str, i), str + ":" + i);
        }

        @Override // javax.net.SocketFactory
        public Socket createSocket(String str, int i, InetAddress inetAddress, int i2) throws IOException {
            return patch(this.delegate.createSocket(str, i, inetAddress, i2), str + ":" + i);
        }

        @Override // javax.net.SocketFactory
        public Socket createSocket(InetAddress inetAddress, int i) throws IOException {
            return patch(this.delegate.createSocket(inetAddress, i), (inetAddress == null ? new StringBuilder() : new StringBuilder().append(inetAddress.getHostName())).append(":").append(i).toString());
        }

        @Override // javax.net.SocketFactory
        public Socket createSocket(InetAddress inetAddress, int i, InetAddress inetAddress2, int i2) throws IOException {
            return patch(this.delegate.createSocket(inetAddress, i, inetAddress2, i2), (inetAddress == null ? new StringBuilder() : new StringBuilder().append(inetAddress.getHostName())).append(":").append(i).toString());
        }
