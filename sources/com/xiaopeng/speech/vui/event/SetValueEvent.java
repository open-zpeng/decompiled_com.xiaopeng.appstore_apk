                    ...
                    if (t instanceof RecyclerView) {
                        if (((IVuiElement) t).getVuiProps() != null) {
                            if (((IVuiElement) t).getVuiProps().has("isReverse") ? ((IVuiElement) t).getVuiProps().getBoolean("isReverse") : false) {
                                ...
                                if (((IVuiElement) t).getVuiProps().has(VuiConstants.PROPS_MAXVALUE)) {
                                    this.value = ((IVuiElement) t).getVuiProps().getInt(VuiConstants.PROPS_MAXVALUE) - this.value;
                                }
                                ...
                                if (((IVuiElement) t).getVuiProps().has(VuiConstants.PROPS_MINVALUE)) {
                                    this.value = (this.value - ((IVuiElement) t).getVuiProps().getInt(VuiConstants.PROPS_MINVALUE)) + 1;
                                }
