...
public class VuiSceneManager {
    ...
    public void insertVuiSceneToProvider(String str, String str2, String str3) {
        ...
        try {
            ...
            if (hashCode == -838846263) {
                if (str3.equals(AccountUtils.USER_DATA_EXTRA_UPDATE)) {
                    c = 1;
                }
                c = 65535;
    ...
    public void vuiFeedBack(final String str, final String str2) {
        ...
        this.mApiRouterHandler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.VuiSceneManager.2
            ...
            public void run() {
                ...
                builder.authority(VuiSceneManager.this.getAuthority()).path("vuiSoundAreaFeedback").appendQueryParameter(VuiConstants.SCENE_PACKAGE_NAME, VuiSceneManager.this.mPackageName).appendQueryParameter("packageVersion", VuiSceneManager.this.mPackageVersion).appendQueryParameter("resourceName", str).appendQueryParameter("state", "-1").appendQueryParameter(VuiConstants.ELEMENT_TYPE, VuiFeedbackType.TTS.getType()).appendQueryParameter(ClientConstants.BINDER.SCHEME, str2).appendQueryParameter("soundArea", "" + intValue);
                try {
    ...
    public void onVuiQueryCallBack(final String str, final String str2, final String str3) {
        ...
        handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.VuiSceneManager.3
            ...
            public void run() {
                ...
                Uri.Builder builder = new Uri.Builder();
                builder.authority(VuiSceneManager.this.getAuthority()).path("onVuiQueryCallBack").appendQueryParameter(VuiConstants.SCENE_ID, str).appendQueryParameter(NotificationCompat.CATEGORY_EVENT, str2).appendQueryParameter("result", str3);
                try {
            ...
            handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.VuiSceneManager.13
                ...
                public void run() {
                    ...
                    if (i2 == 0) {
                        ...
                        VuiSceneManager.this.insertVuiSceneToProvider(vuiScene2.getSceneId(), vuiSceneConvertToString2, AccountUtils.USER_DATA_EXTRA_UPDATE);
                    } else if (i2 == 3) {
        ...
        if (handler != null) {
            handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.VuiSceneManager.18
                ...
                public void run() {
                    ...
                    Uri.Builder builder = new Uri.Builder();
                    builder.authority(VuiSceneManager.this.getAuthority()).path("vuiFeedback").appendQueryParameter(VuiConstants.SCENE_PACKAGE_NAME, VuiSceneManager.this.mPackageName).appendQueryParameter("packageVersion", VuiSceneManager.this.mPackageVersion).appendQueryParameter("resourceName", str).appendQueryParameter("state", "" + vuiFeedback.state).appendQueryParameter(VuiConstants.ELEMENT_TYPE, vuiFeedback.getFeedbackType().getType()).appendQueryParameter(ClientConstants.BINDER.SCHEME, vuiFeedback.content);
                    try {
        ...
        if (handler != null) {
            handler.post(new Runnable() { // from class: com.xiaopeng.speech.vui.VuiSceneManager.19
                ...
                public void run() {
                    ...
                    Uri.Builder builder = new Uri.Builder();
                    builder.authority(VuiSceneManager.this.getAuthority()).path("vuiFeedback").appendQueryParameter(VuiConstants.SCENE_PACKAGE_NAME, VuiSceneManager.this.mPackageName).appendQueryParameter("packageVersion", VuiSceneManager.this.mPackageVersion).appendQueryParameter("resourceName", "").appendQueryParameter("state", "" + vuiFeedback.state).appendQueryParameter(VuiConstants.ELEMENT_TYPE, vuiFeedback.getFeedbackType().getType()).appendQueryParameter(ClientConstants.BINDER.SCHEME, vuiFeedback.content);
                    try {
                        LogUtils.logDebug("VuiSceneManager", "vuiFeedBack ");
                        String str3 = (String) ApiRouter.route(builder.build());
                        LogUtils.logInfo("VuiSceneManager", "vuiFeedBack success");
    ...
    */
    ...
    public boolean isUploadScene(String str) {
        ...
        if ((this.mIsInSpeech && VuiEngineImpl.mActiveSceneIds.containsValue(str) && ("com.xiaopeng.car.settings".equals(this.mPackageName) || "com.xiaopeng.carcontrol".equals(this.mPackageName) || "com.xiaopeng.chargecontrol".equals(this.mPackageName) || "com.xiaopeng.napa".equals(this.mPackageName))) || "com.xiaopeng.caraccount".equals(this.mPackageName)) {
            return true;
        }
