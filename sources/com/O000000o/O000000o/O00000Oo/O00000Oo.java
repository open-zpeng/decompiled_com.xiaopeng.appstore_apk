...
public final class O00000Oo {
    ...
    /* loaded from: classes.dex */
    public static final class C0006O00000Oo implements Serializable, ParameterizedType {
        private static final long O00000o = 0;
        private final Type O000000o;
        private final Type O00000Oo;
        private final Type[] O00000o0;

        public C0006O00000Oo(Type type, Type type2, Type... typeArr) {
            int i = 0;
    ...
    public static ParameterizedType O000000o(Type type, Type type2, Type... typeArr) {
        return new C0006O00000Oo(type, type2, typeArr);
    }
    ...
    */
    ...
    public static Type O00000o(Type type) {
        if (type instanceof Class) {
            ...
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new C0006O00000Oo(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
